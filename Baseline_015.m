...
velocities = zeros(2,TOTAL_STEPS-steps_per_unit_time);
...
xlabel('Timesteps');
ylabel('Velocity (bodylengths/second');
title('Velocity of a swimmer in an infinite expanse of fluid');
text(300,0.0297,'   0.0297');
velocities
format longg
velocities(2,270)
end
